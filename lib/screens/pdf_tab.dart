...
class _PdfTabState extends State<PdfTab> with SingleTickerProviderStateMixin {
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: outlined ? Colors.white : (onTap == null ? color.withValues(alpha: 0.4) : color),
        ...
        child: Row(
          ...
          children: [
            if (loading)
              ...
              Icon(icon,
                  size: 20,
                  color: outlined ? (onTap == null ? Colors.grey : color) : Colors.white),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.straighten_rounded, size: 18, color: _primary),
          ),
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          AnimatedBuilder(
            ...
            child: Container(
              ...
              child: const Icon(Icons.upload_file_rounded, size: 48, color: _primary),
            ),
          ),
        ...
        Expanded(
          child: Container(
            ...
            child: _previewBytes != null
                ...
                : Center(
                    child: Column(mainAxisSize: MainAxisSize.min, children: [
                      Icon(Icons.picture_as_pdf_rounded, size: 56, color: Colors.red.shade300),
                      const SizedBox(height: 8),
                      Text('Preview tidak tersedia', style: TextStyle(color: Colors.grey.shade500)),
                    ]),
                  ),
          ),
        ),
          ...
          Row(
            children: [
              Container(
                ...
                child: const Icon(Icons.tune_rounded, size: 16, color: Color(0xFF7B2FBE)),
              ),
              const SizedBox(width: 10),
              const Text('Kualitas Cetak', style: TextStyle(fontWeight: FontWeight.w700)),
              const Spacer(),
              Container(
                ...
                child: Text(
                  _useDither ? 'Dither ON' : 'Dither OFF',
                  style: TextStyle(
                    fontSize: 11,
              ...
              Switch(
                value: _useDither,
                onChanged: _isPrinting ? null : (v) => setState(() => _useDither = v),
              ),
            ],
          ),
          const SizedBox(height: 10),
  ...
  Widget _buildSliderRow(String label, double value, double min, double max, ValueChanged<double> onChanged, {int? divisions}) {
    return Row(
      children: [
        SizedBox(
          width: 70,
              ...
              child: GestureDetector(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(14),
                    border: Border.all(
                      color: _pdfFile != null ? _primary.withValues(alpha: 0.3) : Colors.grey.shade200,
                      width: 2,
                    ),
                  ),
                  child: _buildPreview(),
            ...
            Row(children: [
              ...
              if (_pdfFile != null)
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Icon(Icons.close_rounded, color: Colors.red.shade400, size: 22),
                  ),
                ),
              ...
              Expanded(
                child: _buildButton(
                  ...
                  outlined: false,
                  loading: _isPrinting,
                  onTap: (_pdfFile == null || _pdfBytes == null || _isPrinting) ? null : _printPdfContent,
                ),
              ),
            ]),
            if (_status.isNotEmpty) ...[
              ...
              Container(
                ...
                child: Text(
                  _status,
                  style: TextStyle(
                    color: _status.startsWith('✅') ? const Color(0xFF06C270) : const Color(0xFFFF3B30),
                    fontWeight: FontWeight.w600,
                    fontSize: 12,
                  ),
                ),
