...
class _HomeScreenState extends State<HomeScreen>
  ...
  Future<void> _loadPrefs() async {
    ...
    setState(() {
      ...
      final paperSaved = prefs.getString('paper_size') ?? 'mm80';
      _paperSize = paperSaved == 'mm58' ? PaperSize.mm58 : PaperSize.mm80;
  ...
  Future<void> _goToSettings() async {
    await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => SettingsScreen(btService: _btService),
      ),
    );
    // Reload paper size setelah kembali dari settings
    final prefs = await SharedPreferences.getInstance();
    final ps = prefs.getString('paper_size') ?? 'mm80';
    setState(() {
      _paperSize = ps == 'mm58' ? PaperSize.mm58 : PaperSize.mm80;
    });
  }
  ...
  Widget _buildStatusHero() {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: (_serverRunning ? _success : _primary)
      ...
      child: Column(
        ...
        children: [
          ...
          _heroBtn(
            ...
            color: _serverRunning ? _danger : _success,
            onTap: _isConnectingBt
                ? null
                : _serverRunning
                ? _stopServer
                : _startServer,
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(
                          fontSize: 12,
                          color:
                          _btConnected ? _success : Colors.grey),
                    ),
                  ],
                ),
              ],
  ...
  Widget _buildStatsRow() {
    final paperLabel =
    _paperSize == PaperSize.mm58 ? '58 mm' : '80 mm';
    return Row(
      children: [
        Expanded(
          child: _statCard(
